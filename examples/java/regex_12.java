    ...
    public Resource getIncrementAllocation() {
        ...
        for (int i = 0; i < resourceTypes.length; ++i) {
            ...
            if (propValue != null) {
                ...
                new Here().given(RESOURCE_REQUEST_VALUE_PATTERN, Pattern.compile("^([0-9]+) ?([a-zA-Z]*)$"))
                    .given(propValue, "123s")
                    .checkTrue(matcher.find()).checkEq(matcher.group(1), "123").checkEq(matcher.group(2), "s");
                if (matcher.matches()) {
